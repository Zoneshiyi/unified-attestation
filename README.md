...
| 路径                | 文档                         | 硬件 / 依赖                                                                            |
| ----------------- | -------------------------- | ---------------------------------------------------------------------------------- |
| CCA / CCA + hydra | [docs/cca.md](docs/cca.md) | ARM CCA + [guest-components](https://github.com/SmartTree-zq1997/guest-components) |
...
| iTrustee              | [docs/protocol.md](docs/protocol.md#per-tee-claims-submods-内)  | iTrustee TEE + libteeverifier.so                                           |
| VirtCCA               | [docs/protocol.md](docs/protocol.md#per-tee-claims-submods-内)  | VirtCCA TEE + libvccaattestation.so                                         |
